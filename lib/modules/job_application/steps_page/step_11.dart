...
class _Step11State extends State<Step11> {
  ...
  TextEditingController niNo = TextEditingController();
  TextEditingController applicantSignature = TextEditingController();
                  ...
                  child: Column(
                    children: [
                      ...
                      InputFormField(
                        ...
                        nextFocusNode: applicantSignatureFocusNode,
                      ),
                      h1,
                      Row(
                        children: [
                          Expanded(
                            child: InputFormField(
                              controller: applicantSignature,
                              label: "Click here for Signature",
                              fieldTitle: "Applicant Signature",
                              focusNode: applicantSignatureFocusNode,
                            ),
                          ),
                          w3,
                          Expanded(
